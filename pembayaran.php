...
<html>
  ...
  <body>
    ...
    if (isset($_POST['kirim']))
    {
      ...
      move_uploaded_file($lokasibukti, "bukti_pembayaran/$namafoto");
      ...
      VALUES ('$idpem','$nama','$bank','$jumlah','$tanggal','$namafoto')");

      $koneksi->query("UPDATE pembelian SET status_pembelian='Pembayaran Selesai'WHERE id_pembelian='$idpem'");
