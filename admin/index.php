<?php
session_start();
  $koneksi = new mysqli("localhost","root","","ilnoise");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">ILNoise Admin</a>
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> <?php echo $_SESSION['admin']['nama_lengkap']; ?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="../foto_admin/ilnoise_logo2.jpg" class="user-image img-responsive"/>
					</li>
                    ...
                    <li><a href="index.php?halaman=laporan_penjualan"><i class="fa fa-file"></i>Laporan</a></li>
                    <li><a href="index.php?halaman=pelanggan"><i class="fa fa-male"></i>Pelanggan</a></li>
                    <li><a href="index.php?halaman=logout"><i class="fa fa-sign-out fa-1x"></i>Logout</a></li>
                </ul>
