...
while ($tiap = $ambilfoto->fetch_assoc())
{
 ...
 <table class="table">
   ...
   <tr>
     <th>Berat</th>
     <td><?php echo number_format($detailproduk['berat_produk']); ?> Gr</td>
   </tr>
   <tr>
     <th>Harga</th>
 ...
 <div class="row">
   <?php foreach ($fotoproduk as $key => $value): ?>
     <div class="col-md-3 text-center">
       <a href="../foto_produk/<?php echo $value['nama_produk_foto'] ?>" target="_blank"><img src="../foto_produk/<?php echo $value['nama_produk_foto'] ?>" alt="" class="img-responsive"></a><br>
